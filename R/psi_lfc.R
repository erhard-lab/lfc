...
CenterMedian <- function(l) l-median(l,na.rm=T)
...
#'     the credible interval as well
#' @export
PsiLFC.se=function(se,contrast,cre=F) {
...
#'     the credible interval as well
#' @export
results <- function(object, contrast, cre=F, ...) {
